...
public class MapCompletionPanelUI : MonoBehaviour
{
    ...
    private IEnumerator HidePanel()
    {
        ...
        // Move bottomPanel back up instantly before closing dialogue panels
        var choiceSelectionUI = FindFirstObjectByType<ChoiceSelectionUI>(FindObjectsInactive.Include);
        if (choiceSelectionUI != null)
        {
            choiceSelectionUI.MoveBottomPanelUp();
        }
        
        // Notify that map completion is finished (this will close dialogue panels)
    ...
    private void OnMapCompletionFinished()
    {
        ...
        // Note: bottomPanel will be moved up in HidePanel coroutine after map selection appears
    }

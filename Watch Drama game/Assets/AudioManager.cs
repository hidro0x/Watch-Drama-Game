...
public class AudioManager : MonoBehaviour
{
    ...
    [SerializeField] private List<AudioClipData> backgroundMusic = new List<AudioClipData>();
    #endregion
    ...
    private void BuildAudioDictionaries()
    {
        ...
        {
            if (sfxData.clip != null && !sfxDictionary.ContainsKey(sfxData.soundType))
            {
        ...
        {
            if (musicData.clip != null && !musicDictionary.ContainsKey(musicData.musicType))
            {
    ...
    {
        if (!audioSettings.masterMuted && !audioSettings.musicMuted)
        {
...
/// <summary>
/// Data structure for audio clips with their corresponding types
/// </summary>
[System.Serializable]
